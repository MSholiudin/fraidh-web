...
<head>
    ...
    <title>Daftar Akun — WEWARIS</title>
    ...
    <div class="min-h-screen flex flex-col md:flex-row">
        ...
        <div class="hidden md:flex md:w-1/2 bg-blue-600 flex-col justify-between p-10 lg:p-14 relative overflow-hidden">
            ...
            <div class="relative z-10">
                ...
                <p class="mt-2 text-blue-200 text-sm">Bergabung untuk akses fitur lengkap</p>
            </div>
            ...
            <div class="relative z-10 space-y-3">
                @foreach([
                    ['icon' => 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2', 'title' => 'Simpan Riwayat Perhitungan', 'desc' => 'Akses hasil perhitungan waris kapan saja'],
                    ['icon' => 'M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z', 'title' => 'Rekomendasi Islah Ekonomi', 'desc' => 'Solusi musyawarah yang adil dan terukur'],
                    ['icon' => 'M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253', 'title' => 'Akses Materi Faraidh Lengkap', 'desc' => 'Belajar ilmu waris Islam secara mandiri'],
                ] as $f)
        ...
        {{-- ================================================ --}}
        <div class="w-full md:w-1/2 flex items-center justify-center p-6 lg:p-12 overflow-y-auto">
            <div class="w-full max-w-md">
                ...
                <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-8">
                    ...
                    <div class="mb-8">
                        ...
                        <p class="text-gray-500 text-sm mt-1">Mulai langkah tepat pembagian waris</p>
                    </div>
                    ...
                    <div class="mt-6 text-center space-y-4">
                        <p class="text-gray-500 text-sm">
                            Sudah punya akun?
                            <a href="{{ route('login') }}" class="text-blue-600 font-black hover:underline underline-offset-4">
                                Masuk
                            </a>
                        </p>
                        <a href="{{ route('home') }}"
